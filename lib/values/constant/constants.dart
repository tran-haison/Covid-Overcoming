class Constants {
  ...
  static const errorReAuthenticateWithCredential = 'Error re-authenticate with credential';
  ...
  static const codeFirebaseInvalidVerificationCode = 'invalid-verification-code';
  ...
  static const codeFirebaseAuthMissingAndroidPkgName = 'auth/missing-android-pkg-name';
  static const codeFirebaseAuthMissingContinueUri = 'auth/missing-continue-uri';
  static const codeFirebaseAuthMissingIosBundleId = 'auth/missing-ios-bundle-id';
